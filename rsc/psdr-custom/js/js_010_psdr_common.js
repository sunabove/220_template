...
$( function () { 
	...
	// number only for input type text of clas kzNumberOnly
	
	$(document).on( "input", ".kzNumberOnly", function() {
	...
	$(document).on( "input", ".kzDateOfMonth", function( e ) {
...
function showAjaxLoader( ajaxLoader ) {
	...
	$loader.css( { position: "absolute" , zIndex: 1000000, left: 0 , top: 0 } );

	$loader.position( { of : $location , "my" : my , "at" : at , "offset" : offset } );
...
$( document ).on( "submit", "form" ,
	function( e ) {
		var ajaxLoader = { "size" : "lg" , $location : $( "body" ) , hideInterval : 1000 } ; 
